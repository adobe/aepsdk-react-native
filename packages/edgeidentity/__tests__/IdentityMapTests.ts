...
describe('IdentityMap', () => {
  ...
  it('IdentityMap addItem is validated', async () => {
    ...
    expect(itemsForNamespace1).toEqual([{"id": identifier1, "authenticatedState": authenticatedState1, "primary": isPrimary1}, {"id": identifier2, "authenticatedState": authenticatedState2, "primary": isPrimary2}]);
 ...
 it('IdentityMap addItem replaces items with same id', async () => {
    ...
    var expectedItems = [{"id": identifier1, "authenticatedState": authenticatedState1, "primary": isPrimary1}]; 
    ...
    expectedItems = [{"id": identifier1, "authenticatedState": authenticatedState2, "primary": false}]; // primary false by default 
    expect(itemsForNamespace).toEqual(expectedItems); 
 });
 ...
 it('IdentityMap removeItem is validated', async () => {
    ...
    expect(itemsForNamespace2).toEqual([{"id": identifier3, "authenticatedState": authenticatedState3, "primary": false}]);
