...
static NSString* const QUERY_KEY = @"query";
...
+ (AEPExperienceEvent *)experienceEventFromDictionary: (nonnull NSDictionary *) dict {
    ...
    if (([[dict objectForKey:XDM_DATA_KEY] isKindOfClass:[NSDictionary class]] || ![dict objectForKey:XDM_DATA_KEY]) && ([[dict objectForKey:DATA_KEY] isKindOfClass:[NSDictionary class]] || ![dict objectForKey:DATA_KEY]) && ([[dict objectForKey:QUERY_KEY] isKindOfClass:[NSDictionary class]] || ![dict objectForKey:QUERY_KEY]) && ([[dict objectForKey:DATASET_IDENTIFIER_KEY] isKindOfClass:[NSDictionary class]] || ![dict objectForKey:DATASET_IDENTIFIER_KEY])) {
...
+ (NSDictionary *)dictionaryFromExperienceEvent: (nonnull AEPExperienceEvent *) experienceEvent {
    ...
    experienceEventDict[QUERY_KEY] = experienceEvent.query;
