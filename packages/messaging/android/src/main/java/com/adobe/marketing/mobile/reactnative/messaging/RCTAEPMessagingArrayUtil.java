...
public class RCTAEPMessagingArrayUtil {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            ...
            switch (type) {
                ...
                case String:
                    ...
                    break;
                case Map:
                    array[i] = RCTAEPMessagingMapUtil.toMap(readableArray.getMap(i));
                    break;
                case Array:
                    array[i] = RCTAEPMessagingArrayUtil.toObjectArray(readableArray.getArray(i));
                    break;
            }
        }
    ...
    public static WritableArray toWritableArray(Object[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            if (value == null) {
                ...
                writableArr.pushMap(RCTAEPMessagingMapUtil.toWritableMap((Map<String, Object>) value));
            } else if (value.getClass().isArray()) {
                writableArr.pushArray(RCTAEPMessagingArrayUtil.toWritableArray((Object[]) value));
            }
        }
