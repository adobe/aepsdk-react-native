...
#ifndef AEPOPTIMIZE_SWIFT_H
#define AEPOPTIMIZE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AEPOptimize",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AEPOffer (SWIFT_EXTENSION(AEPOptimize))
...
@interface AEPMobileOptimize (SWIFT_EXTENSION(AEPOptimize))
...
@interface AEPProposition (SWIFT_EXTENSION(AEPOptimize))
