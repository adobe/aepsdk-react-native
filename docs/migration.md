...
| @adobe/react-native-acpanalytics | NA, workflows supported through [Edge Network](/aepsdk-react-native/packages/edge) or [Edge Bridge](/aepsdk-react-native/packages/edgebridge) extension. |
| @adobe/react-native-acpmedia | NA |
| @adobe/react-native-acpaudience | NA |
| @adobe/react-native-acptarget | @adobe/react-native-aeptarget, for using Analytics for Target, workflows supported through [Edge Network](/aepsdk-react-native/packages/edge) and [Optimize](/aepsdk-react-native/packages/optimize) extensions. |
