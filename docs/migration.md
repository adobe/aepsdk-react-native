...
| @adobe/react-native-acptarget | @adobe/react-native-aeptarget, for using Analytics for Target, workflows supported through [Edge Network](../packages/edge) and [Optimize](../packages/optimize) extensions. |
