...
RCT_EXTERN_METHOD(startAirplaneActivity:(NSString *)liveActivityID
                  departureAirport:(NSString *)departureAirport
                  arrivalAirport:(NSString *)arrivalAirport
                  arrivalTerminal:(NSString *)arrivalTerminal
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject)

RCT_EXTERN_METHOD(startAirplaneActivityWithChannel:(NSString *)channelID
                  departureAirport:(NSString *)departureAirport
                  arrivalAirport:(NSString *)arrivalAirport
                  arrivalTerminal:(NSString *)arrivalTerminal
                  resolver:(RCTPromiseResolveBlock)resolve
...
RCT_EXTERN_METHOD(updateActivityProgress:(NSString *)activityId
...
RCT_EXTERN_METHOD(getRunningActivities:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject)
